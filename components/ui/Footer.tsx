        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-1">
            ...
            <div className="flex space-x-4 mt-4">
              <a href="https://www.instagram.com/rapidcompaniesltd" className="text-gray-400 hover:text-blue-400">
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
              ...
              <a href="https://www.linkedin.com/company/rapidcompanies" className="text-gray-400 hover:text-blue-400">
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"

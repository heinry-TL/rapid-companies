...
export async function POST(request: NextRequest) {
  try {
    ...
    await conn.execute(query, [
      applicationData.id,
      (applicationData.jurisdiction as any).id,
      (applicationData.jurisdiction as any).name,
      (applicationData.jurisdiction as any).price,
      (applicationData.jurisdiction as any).currency,
      (applicationData.contactDetails as any).firstName || null,
      (applicationData.contactDetails as any).lastName || null,
      (applicationData.contactDetails as any).email || null,
      (applicationData.contactDetails as any).phone || null,
      (applicationData.contactDetails as any).address.line1 || null,
      (applicationData.contactDetails as any).address.line2 || null,
      (applicationData.contactDetails as any).address.city || null,
      (applicationData.contactDetails as any).address.county || null,
      (applicationData.contactDetails as any).address.postcode || null,
      (applicationData.contactDetails as any).address.country || 'United Kingdom',
      (applicationData.companyDetails as any).proposedName || null,
      (applicationData.companyDetails as any).alternativeName || null,
      (applicationData.companyDetails as any).businessActivity || null,
      (applicationData.companyDetails as any).authorizedCapital || 50000,
      (applicationData.companyDetails as any).numberOfShares || 50000,
      (applicationData.registeredAddress as any).line1 || null,
      (applicationData.registeredAddress as any).line2 || null,
      (applicationData.registeredAddress as any).city || null,
      (applicationData.registeredAddress as any).county || null,
      (applicationData.registeredAddress as any).postcode || null,
      (applicationData.registeredAddress as any).country || 'United Kingdom',
      (applicationData.registeredAddress as any).useContactAddress || false,
